                ...
                <Section className="pt-6 sm:pt-0">
                    ...
                    >
                        <div className="flex flex-col gap-3">
                            ...
                            <p className="text-zinc-600">Desenvolvida em <strong>sete camadas</strong>, as quais são <strong>resistentes a perfurações</strong>, possuem dupla face branca e preta para <strong>reduzir os impactos da incidência solar</strong>.</p>
                        </div>
                    </HeroFlex>
                    <HeroFlex
                        imagePath="bg6"
