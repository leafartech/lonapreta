...
export default function Page() {
    return (
        <div className="bg-zinc-50">
            ...
            >
                Garanta uma lona de <span className="text-my">alta proteção e durabilidade</span> para o seu caminhão
            </HeaderFlex>
            <main>
                ...
                <Section className="pt-6 sm:pt-0">
                    <HeroFlex
                        imagePath="bg3"
                        title="A melhor opção para o seu caminhão"
                        cta="Quero fazer um orçamento"
                        href="#cadastro"
                    >
                        <div className="flex flex-col gap-3">
                            <p className="text-zinc-600">Nossas lonas são feitas com uma tecnologia avançada que oferece maior proteção e uma alta durabilidade.</p>
                            <p className="text-zinc-600">Elas são desenvolvidas em sete camadas, as quais permitem uma alta resistência a perfurações e são 100% impermeáveis.</p>
                        </div>
                    </HeroFlex>
                </Section>
